...
#define ACCESS_MAGISTRATE 58 // Magistrate's office
#define ACCESS_CE 59
#define ACCESS_HOP 60
#define ACCESS_HOS 61
#define ACCESS_RC_ANNOUNCE 62 //Request console announcements
#define ACCESS_KEYCARD_AUTH 63 //Used for events which require at least two people to confirm them
#define ACCESS_TCOMSAT 64 // has access to the entire telecomms satellite / machinery
#define ACCESS_GATEWAY 65
#define ACCESS_SEC_DOORS 66 // Outer brig doors, department security posts
#define ACCESS_MINERAL_STOREROOM 67 //For releasing minerals from the ORM
#define ACCESS_MINISAT 68
#define ACCESS_WEAPONS 69 //Weapon authorization for secbots
#define ACCESS_NETWORK 70 //NTnet diagnostics/monitoring software
#define ACCESS_CLONING 71 //Cloning room and clone pod ejection
