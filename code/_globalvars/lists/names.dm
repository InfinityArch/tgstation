...
GLOBAL_LIST_INIT(first_names_generic, world.file2list("strings/names/generic_first.txt"))
GLOBAL_LIST_INIT(last_names_generic, world.file2list("strings/names/generic_last.txt"))
...
GLOBAL_LIST_INIT(nightmare_names, world.file2list("strings/names/nightmare_first_male.txt"))
