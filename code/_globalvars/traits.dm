...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		//psionic traits
		"TRAIT_PSYCHIC"	  = TRAIT_PSYCHIC, // tells us this mob is psychic, and thus needs to have a psionics datum added to it 
		"TRAIT_PSYRESIST"  = TRAIT_PSYRESIST,

	),
	/obj/item/bodypart = list(
		"TRAIT_PARALYSIS" = TRAIT_PARALYSIS,
		"TRAIT_PART_CRIT" = TRAIT_PART_CRIT,
		"TRAIT_STAMINA_DISABLED" = TRAIT_STAMINA_DISABLED,
		"TRAIT_DAMAGE_DISABLED"  = TRAIT_DAMAGE_DISABLED,
		"TRAIT_FRAGILE_BONES"	 = TRAIT_FRAGILE_BONES,
		"TRAIT_NO_BONES"		 = TRAIT_NO_BONES,
		"TRAIT_BROKEN_BONES"	 = TRAIT_BROKEN_BONES,
		"TRAIT_SPLINTED_BONES"	 = TRAIT_SPLINTED_BONES,
		"TRAIT_INTERNAL_BLEEDING"= TRAIT_INTERNAL_BLEEDING,
		"TRAIT_EXTERNAL_BLEEDING"= TRAIT_EXTERNAL_BLEEDING
	),
	/obj/item = list(
