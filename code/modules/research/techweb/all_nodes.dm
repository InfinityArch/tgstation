...
/datum/techweb_node/cyborg_upg_util
	...
	design_ids = list("borg_upgrade_thrusters", "borg_upgrade_selfrepair", "borg_upgrade_expand", "borg_upgrade_disablercooler", "borg_upgrade_trashofholding", "borg_upgrade_advancedmop", "borg_upgrade_vtec", "ipc_coolant_pump_radiative")
